...
from langchain_community.embeddings import SentenceTransformerEmbeddings # Changed import
# --- Initialization & Config ---
load_dotenv()
GOOGLE_PROJECT_ID = os.environ.get("GOOGLE_PROJECT_ID")
GOOGLE_PROCESSOR_ID = os.environ.get("GOOGLE_PROCESSOR_ID")
GOOGLE_PROCESSOR_LOCATION = os.environ.get("GOOGLE_PROCESSOR_LOCATION")
